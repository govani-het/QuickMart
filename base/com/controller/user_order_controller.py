...
def checkout_order():
    ...
    userAddressInfo = userDAO.view_address(user_id)
    ...
    return render_template('/user/checkout.html',userinfo=userinfo,city=city,user_cart_data=user_cart_data,final_price=final_price,userAddressInfo=userAddressInfo)
