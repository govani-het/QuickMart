...
class SubCategoryVO(db.Model):
    ...
    subcategory_category_id = db.Column('subcategory_category_id',db.Integer,db.ForeignKey(CategoryVO.category_id,ondelete='CASCADE',onupdate='CASCADE'),nullable=False)
